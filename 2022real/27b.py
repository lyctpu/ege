...
л# параметр start - позиция начала поиска, step-шаг поиска. значение в range - 100-это количество расчетов. В конце выдается вся табоица и находится минимальное, откуда можно и дальше сужать поиск
